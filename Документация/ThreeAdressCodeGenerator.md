...
* AST-дерево (AST – Abstract Syntax Tree) - это представление исходного кода программы в древовидной структуре. В отличии от
...
Для проведения большинства оптимизация использовавние AST-дерева является неэффективным.
...
```
После генерацции трехадресного кода получаетя следующий код:
```csharp
           r = 3.14
           temp_2 = r < 6.28
           temp_1 = temp_2 && True
