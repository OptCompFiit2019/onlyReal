...
1. Устанавливаем результат для входа - множество, состоящее из входа;
2. Для остальных блоков - множество из всех блоков
3. Пока вносятся изменения в результат:
4. Для каждого блока(B) != входу
	1. Найти пересечение (⋂) результатов блоков входящих в этот 
	2. Установить результат этого блока = {⋂} U {B}
